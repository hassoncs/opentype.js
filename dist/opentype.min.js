...
"use strict";function parseKernTable(r,e){var s,a,t,n,o,p,c,h,i;s={};try{for(a=new parse.Parser(r,e),t=a.parseUShort(),check.argument(0===t,"Unsupported kern table version."),a.skip("uShort",1),n=a.parseUShort(),check.argument(0===n,"Unsupported kern sub-table version."),a.skip("uShort",2),o=a.parseUShort(),a.skip("uShort",3),p=0;o>p;p+=1)c=a.parseUShort(),h=a.parseUShort(),i=a.parseShort(),s[c+","+h]=i}catch(u){console.log("An error occured while parsing the kerning tables. No kerning will be included.",u)}return s}var check=require("../check"),parse=require("../parse");exports.parse=parseKernTable;
